# BALI 5.0 — Configuration (config.py)

Единственный источник всех констант системы.
...
| `COOLDOWN_SECONDS` | 3600 | Из спецификации |
| `SNAPSHOT_DURATION` | 3500 | Из спецификации |
| `CHUNK_DURATION` | 1200 | 20 минут = из спецификации |
| `CHUNK_TTL` | 6000 | 100 мин = 5 × chunk_duration, покрывает 4 активных чанка |
| `SPREAD_DATA_STALE_MS` | 5000 | Данные старше 5 сек — не торгуем по ним |
| `WS_CHUNK_BYBIT` | 10 | Bybit документация: 10 topics на subscribe message |
| `WS_CHUNK_OKX` | 100 | OKX документация: до 240 args, берём 100 с запасом |
